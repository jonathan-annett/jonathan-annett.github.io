...
ml(`
    ...
    {   
        ServiceWorkerGlobalScope: function zipPNGLib (  sha1Lib, UPNG, pako ) {
            
            
            
            return function (getUpdatedZipFile,response200) {
                       ...
                       const expectHashLength = sha1Lib.sync.raw('x').byteLength;
            ...
            ServiceWorkerGlobalScope: [ ()=> ml.i.sha1Lib, ()=> ml.i.UPNG, ()=>ml.i.pako  ]
