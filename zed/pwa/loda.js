...
function ml(x, L, o, a, d, s) {
    ...
    return (e = typeof r[x] === t[1] ? r[x](L, o, a, d, s) : r) !== r ? e : (e = {
        ...
        p: (t, l, p, L, m, n) => (p = r.r(), L = (r => l(e.V(t, r))), m = (r => L(e.v(t, r))), n = (() => m(p)), ml.h[t] ? m(ml.h[t]) : typeof fetch === e.F ? fetch(t, {
            method: "HEAD"
        }).then(e => m(e.headers.get("Etag") || p)).
        catch (n) : n()),
        V: (t, r) => e.F ? t + "?v=" + r : t,
        v: (e, t) => ml.h[e] = t.replace(/[\"\/\\\-]*/g, ""),
        r: e => /([\w\$]*)(?:\s*\|)(?:\s*)([A-z0-9\:\/\-\_\.\@\~\#\!]+)/.exec(e)
    })[x](L, o, a, d, s)
}
//minified
function ml(x,L,o,a,d,s){ml.h=ml.h||{};let e,t=[{},ml,"",e].map(e=>typeof e),r={1:()=>r[4]()||{},2:(L,o,a,d,e,p)=>{e=typeof(e=a[L]&&a[L].name)+typeof o[e]===t[2]+t[3]?Object.defineProperty(o,e,{value:a[L].apply(this,d[L].map(r.x)),enumerable:!0,configurable:!0}):p},3:()=>r[4]().constructor.name||"x",4:()=>typeof self===t[0]&&self,x:e=>e(),r:()=>Math.random().toString(36).substr(-8)};return(e=typeof r[x]===t[1]?r[x](L,o,a,d,s):r)!==r?e:(e={F:t[1],0:()=>e.l(o),l:t=>(t=t.map(e.u).filter(e.y)).length?setTimeout(e.l,t.length+1,t):a(),u:(x,t)=>(t=e.r(x))?(s=e.s(this.document,"script"),d&&d(s),e.p(t[2],s.setAttribute.bind(s,"src")),t[1]):!L[x]&&x,y:x=>!!x,s:(d,e)=>((s=d.createElement(e)).type="text/java"+e,d.body.appendChild(s)),p:(t,l,p,L,m,n)=>(p=r.r(),L=(r=>l(e.V(t,r))),m=(r=>L(e.v(t,r))),n=(()=>m(p)),ml.h[t]?m(ml.h[t]):typeof fetch===e.F?fetch(t,{method:"HEAD"}).then(e=>m(e.headers.get("Etag")||p)).catch(n):n()),V:(t,r)=>e.F?t+"?v="+r:t,v:(e,t)=>ml.h[e]=t.replace(/[\"\/\\\-]*/g,""),r:e=>/([\w\$]*)(?:\s*\|)(?:\s*)([A-z0-9\:\/\-\_\.\@\~\#\!]+)/.exec(e)})[x](L,o,a,d,s)}
// source -dev version (precaches via fetch/HEAD)
function ml(x,L, o, a, d, s){
    ...
    z = {
       F:t[1],// F:t[1] = use fetch, F:false,  = don't use fetch
...
// prod 
function ml(x,L,o,a,d,s){ml.h=ml.h||{};let e,t=[{},ml,"",e].map(e=>typeof e),r={1:()=>r[4]()||{},2:(L,o,a,d,e,p)=>{e=typeof(e=a[L]&&a[L].name)+typeof o[e]===t[2]+t[3]?Object.defineProperty(o,e,{value:a[L].apply(this,d[L].map(r.x)),enumerable:!0,configurable:!0}):p},3:()=>r[4]().constructor.name||"x",4:()=>typeof self===t[0]&&self,x:e=>e(),r:()=>Math.random().toString(36).substr(-8)};return(e=typeof r[x]===t[1]?r[x](L,o,a,d,s):r)!==r?e:(e={F:!1,0:()=>e.l(o),l:t=>(t=t.map(e.u).filter(e.y)).length?setTimeout(e.l,t.length+1,t):a(),u:(x,t)=>(t=e.r(x))?(s=e.s(this.document,"script"),d&&d(s),e.p(t[2],s.setAttribute.bind(s,"src")),t[1]):!L[x]&&x,y:x=>!!x,s:(d,e)=>((s=d.createElement(e)).type="text/java"+e,d.body.appendChild(s)),p:(t,l,p,L,m,n)=>(p=r.r(),L=(r=>l(e.V(t,r))),m=(r=>L(e.v(t,r))),n=(()=>m(p)),ml.h[t]?m(ml.h[t]):typeof fetch===e.F?fetch(t,{method:"HEAD"}).then(e=>m(e.headers.get("Etag")||p)).catch(n):n()),V:(t,r)=>e.F?t+"?v="+r:t,v:(e,t)=>ml.h[e]=t.replace(/[\"\/\\\-]*/g,""),r:e=>/([\w\$]*)(?:\s*\|)(?:\s*)([A-z0-9\:\/\-\_\.\@\~\#\!]+)/.exec(e)})[x](L,o,a,d,s)}
...
function ml(x,L, o, a, d, s){
    ...
    z = {
       F:false,// F:t[1] = use fetch, F:false,  = don't use fetch
